...
Future<dynamic> fetchAlbum() async {
  ...
  final url =
      Uri.parse('https://tatapi.tourismthailand.org/tatapi/v5/places/search?keyword=wat&location=13.6904831,100.5226014&categorycodes=Other');
...
class _MyAppState extends State<OtherPage> {
